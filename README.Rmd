...
The main function **ucdplink** produces a conflict-month dataset with information on monthly casualties from various forms of violence. For more details on the variables included in final dataset please consult the [Codebook](https://github.com/corinnebara/ucdplink/releases/download/v1.0.0/Codebook.pdf). The procedure has three steps:
